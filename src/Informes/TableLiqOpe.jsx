...
function TableLiqOpe() {
    ...
    useEffect(() => {
        setData([
            { col1: 'Data 1', col2: 'Data 2', col3: 'Data 3', col4: 'Data4', col5: 'Data4', },
            { col1: 'Data 1', col2: 'Data 2', col3: 'Data 3', col4: 'Data4', col5: 'Data4', },
            { col1: 'Data 1', col2: 'Data 2', col3: 'Data 3', col4: 'Data4', col5: 'Data4', },
            { col1: 'Data 1', col2: 'Data 4', col3: 'Data 3', col4: 'Data4', col5: 'Data4', },
            { col1: 'Data 1', col2: 'Manuel Cordero', col3: 'Data 3', col4: 'Data4', col5: 'Data4', },
            { col1: 'Data 1', col2: 'Data 4', col3: 'Data 3', col4: 'Data4', col5: 'Data4', },
            { col1: 'Data 1', col2: 'Data 4', col3: 'Data 3', col4: 'Data4', col5: 'Data4', },
            { col1: 'Data 1', col2: 'Data 4', col3: 'Data 3', col4: 'Data4', col5: 'Data4', },
            { col1: 'Data 1', col2: 'Data 4', col3: 'Data 3', col4: 'Data4', col5: 'Data4', },
            ...
            <table className='table001'>
                <thead>
                    <tr className='tr001'>
                        ...
                        <th className='th001'>Comision Por Servicios</th>
                        <th className='th001'>Total</th>
                    </tr>
                </thead>
                <tbody>
                    {data.slice(startIndex, endIndex).map((item, index) => (
                        <tr className='tr001'>
                            ...
                            <td className='td001'>{item.col5}</td>
                        </tr>
                    ))}
                    <tr className='tr001'>
