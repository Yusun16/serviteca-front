...
export default function () {
  return (
    ...
    <div>
      <div className="modal fade " id="modalagregarcliente" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
        <div className="modal-dialog modal-dialog-centered">
          <div className="modal-content">
            ...
            <a type="" href='/agregarcliente' className="btnn-color-modal">Ok</a >
            </div>
